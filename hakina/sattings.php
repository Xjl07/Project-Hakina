...
<head>
    ...
    <style>
        ...
        .settings-item {
            ...
            /* إزالة الخط تحت الرابط وتغيير اللون */
           .settings-item a {
           text-decoration: none;  /* إزالة الخط تحت النص */
            color: inherit;  /* استخدام نفس لون النص بدلاً من اللون الافتراضي الأزرق */
}  
        .settings-item img {
...
<body>
    ...
    <div class="content">
        ...
        <div class="settings-grid">
            ...
            <div class="settings-item">
            <a href="hiding.php"> <!-- رابط حولنا الـ div -->
                <img src="hiding.jpg" alt="Hiding Words Icon">
                <span>Hiding Words</span>
                </a>
            </div>
            <div class="settings-item">
            <a href="data.php"> <!-- رابط حولنا الـ div -->
